...
**Status:** ✅ **ADOPTED at CTP pin `11126a8` (2026-07-08) — three halves closed:** §30.4 (CL-550) + §30.5 (CL-551) + §30.6 (CL-552, aligning stack entry shape + idempotency to GCTP's 19-assertion acceptance test). GCTP re-pinned via ADR-0091 (§15-gated); consumer-side reconciled the pre-wire `stack[]` source enum to CTP's shipped `[stack-add, vision, answer]`. Full details at [`docs/adr/0091-plugin-pin-bump-f39fcdc-to-11126a8.md`](adr/0091-plugin-pin-bump-f39fcdc-to-11126a8.md).
