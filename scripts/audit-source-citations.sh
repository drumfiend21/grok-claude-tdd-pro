...
# Only `_community` (the operator-extensible namespace) qualifies now. CTP's cloud
# + governance namespaces (aws/azure/gcp/hashicorp/linux-foundation/
# security-governance/us-government) were guidance-only and allow-listed under
# ADR-0052, but pin 3432b52 (Layer-A activation, ADR-0053) turned them into
# rule-bearing detector namespaces — so they are back under A3's guard.
